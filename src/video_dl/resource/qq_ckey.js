// copied from https://github.com/ZSAIm/iqiyi-parser/blob/master/js/tencent.js
...
///////////////////////////////// load wasm ///////////////////////////////////////
const fs = require('fs');
var wasm_data = fs.readFileSync('@wasm_path@')
...
console.log(getckey('10201', '3.5.57', '@vid@', '', '@guid@', '@tm@'));